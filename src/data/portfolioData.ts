...
export const PROJECTS: Project[] = [
  {
    ...
    interactiveDemoType: 'recommendation'
  },
  {
    id: 'tek-climate',
    number: '02 / 06',
  ...
  },
  {
    ...
    interactiveDemoType: 'categorizer'
  },
  {
    id: 'stock-prediction',
    number: '05 / 06',
...
export const TERMINAL_COMMANDS: Record<string, string> = {
  ...
  • bio            - View Matheesha's background & university credentials
  • projects       - List all 6 key projects
  • luminary       - Deep dive into featured project Luminary
  • tek            - Overview of TEK Climate offline RAG system
  • skills         - Summary of AI/ML, backend, and frontend capabilities
  • contact        - View email and social links
  • train          - Run live simulated model training checkpoint
  • jdm            - Quick easter egg about Matheesha's automotive hobby
  • clear          - Clear terminal screen`,

  bio: `MATHEESHA ILEPERUMA
Location: Melbourne, Australia
Education: B.Comp.Sc. (Artificial Intelligence) @ Swinburne University of Technology
Graduation: 2025
Focus: Production AI Systems, RAG Architectures, Recommendation Engines, Offline Edge LLMs.
Status: OPEN TO 2025 GRAD ROLES & INTERNSHIPS`,

  projects: `PROJECT REGISTRY:
  [01] LUMINARY (Featured)  -> Cross-media AI conversational recommender (FastAPI, pgvector, Claude, React)
  [02] TEK CLIMATE SYSTEM   -> 100% offline RAG chatbot preserving indigenous knowledge (Phi-4 14B, ChromaDB)
  [03] SHOPWISE AI          -> Content-based TF-IDF cosine similarity recommender (scikit-learn, Flask)
  [04] FINANCE CATEGORISER  -> Bank transaction classifier with 100% test accuracy (Naive Bayes, Recharts)
  [05] STOCK PRICE FORECAST -> AAPL time-series deep ensemble with Bi-GRU (R2 = 0.965) & ARIMA
  [06] AI4CYBER             -> Spam detection (SVM/NB) & malware PE header classifier (Random Forest)
Type the project name (e.g. 'luminary', 'tek') for architectural details.`,

  luminary: `LUMINARY ARCHITECTURE:
Frontend: React 18 + TypeScript + Vite + Tailwind CSS on Vercel
Backend: FastAPI + SQLModel on Render
Vector DB: PostgreSQL 16 + pgvector (1536-dim semantic search)
LLM Engine: Claude 3.5 Sonnet & GPT-4o-mini with cross-media reasoning
CI/CD: GitHub Actions with strict lint, pytest, and build gatekeepers`,

  tek: `TEK CLIMATE SYSTEM:
Objective: Preserve traditional ecological knowledge for remote indigenous community in Bangladesh.
Infrastructure: Edge hardware with ZERO internet requirement.
Stack: Phi-4 14B + Ollama + ChromaDB (all-MiniLM-L6-v2) + Flask + SQLite + Docker.`,

  skills: `CORE COMPETENCIES:
  • AI / LLM: PyTorch, TensorFlow, LangChain, RAG, Ollama, Claude API, pgvector, ChromaDB
  • ML / Stats: scikit-learn, LSTM/GRU, ARIMA, TF-IDF, Naive Bayes, Random Forest, SVM
  • Backend: Python (FastAPI, Flask), PostgreSQL 16, SQLModel, JWT Auth, Docker
  • Frontend: React 18, TypeScript, Tailwind CSS, Motion/React, Recharts
  • DevOps: GitHub Actions CI/CD, Docker, Linux, Vercel, Render`,
  ...
  jdm: `[JDM GARAGE LOG]
  • Chassis: 90s Japanese Sports Coupe Enthusiast
  • Garage Status: Sourcing rare forged wheels & tuning apex lines
  • Vinyl in Player: Late night jazz-funk & lo-fi city pop
  • Dev Vibe: 2 AM code sessions, dark terminals & clean pull requests.`
};
